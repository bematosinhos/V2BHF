...
const cursorPrompt = `Clone the SBC Starter Kit repository from https://github.com/m4n3z40/sbc-cursor-starter-kit, run the 'setup' npm script, install all dependencies and start the development server. Then ask me what I want to build on top of this scaffold and break down the steps to build it based on what I answer.`
